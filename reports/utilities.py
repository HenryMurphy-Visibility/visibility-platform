    ...
    try:
        with open(investment_master_path, mode='r', encoding='utf-8') as csvfile:
            ...
            for row in reader:
                ...
                repository.update_investment_space(investment, 'AIF', 'Put_Call', row.get('Put_Call', None))
                repository.update_investment_space(investment, 'AIF', 'Strike', row.get('Strike', None))
                repository.update_investment_space(investment, 'AIF', 'Underlying', row.get('Underlying', None))
